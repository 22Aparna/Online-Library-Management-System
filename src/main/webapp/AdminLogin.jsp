		   ...
		   <div class="box1"><br><br><br>
				 <h1 style="text-align: center; font-size: 30px;">Login Form</h1><br>
				    ...
				    <form name="login" action="/AdminLogin" method="post">
                     	<div class="login">
                     	     <input class="form-control" type="text" name="Adname" placeholder="Login" > <br><br>
                     	     <input class="form-control" type="password" name="Adpassword" placeholder="Password" > <br><br>
