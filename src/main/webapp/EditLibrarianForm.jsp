 ...
 <section>
	 <div class="log_img"><br><br><br>
		   <div class="box2"><br><br><br>
				 <h1 style="text-align: center; font-size: 30px;">Edit Librarian</h1><br>
				
				    <form name="login" action="/editLibrarian" method="post">
                     	<div class="login">
                     	     ...
                     	     <input class="form-control" type="text" name="libpassword" placeholder="Password" > <br><br>
                     	     <input class="form-control" type="password" name="libcontact" placeholder="Mobile No" > <br><br>
