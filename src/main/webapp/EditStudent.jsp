	 ...
	 <div class="log_img"><br><br><br>
		   <div class="box1"><br><br><br>
				 <h1 style="text-align: center; font-size: 30px;">Login Form</h1><br>
				    ...
				    <form name="login" action="/editStudent" method="post">
                     	<div class="login">
                     	     <input class="form-control" type="text" name="studentid" placeholder="Student Id" > <br><br>
                     	     <input class="form-control" type="text" name="studenrollment" placeholder="Enrollment Number" > <br><br>
                     	     <input class="form-control" type="text" name="studname" placeholder="Name" > <br><br>
                     	     <input class="form-control" type="text" name="studemail" placeholder="Email" > <br><br>
